...
const Pricing = () => {
  const features = ["Custom sculpted from your photo", "Hand-painted with premium colors", "Premium packaging for safety", "Waterproof piece", "Confirmation before printing the design", "Express delivery available"];
