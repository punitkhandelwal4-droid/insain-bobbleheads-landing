        ...
        >
          <div className="relative bg-card rounded-3xl border-2 border-primary p-8 md:p-10 card-shadow overflow-hidden">
            ...
            <div className="relative">
              ...
              <a 
                href="#contact"
                className="block w-full btn-primary-gradient text-primary-foreground py-4 rounded-full font-semibold text-lg text-center hover:opacity-90 transition-all hover:scale-[1.02]"
              >
